  ...
  return (
    <section className="!bg-black !text-white !py-12 md:!py-24 !min-h-0 md:!min-h-screen !flex !flex-col !items-center !justify-center !overflow-x-clip">
      <div className="!container !mx-auto !max-w-6xl !px-4 sm:!px-6 lg:!px-0 !w-full">
        ...
        {/* Community — centred, rolling researcher count */}
        <motion.div
        ...
        >
          ...
          <p className="!text-gray-400 !text-base md:!text-lg !leading-relaxed !max-w-2xl !mx-auto !mt-4">
          ...
          >
            ...
            <p className="!mt-4 !text-base md:!text-xl !text-zinc-300 !max-w-xl !mx-auto">
              Backed by 30+ Malaysian researchers from top institutions around
              the world
            </p>
          </motion.div>

          <div className="!flex !flex-col sm:!flex-row !gap-3 !pt-10 !justify-center !w-full sm:!w-auto">
            <a
