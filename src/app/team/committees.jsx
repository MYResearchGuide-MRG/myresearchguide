...
const TEAM_MEMBERS = {
  directors: [
    { name: "Dun Li Chan", role: "Founder, Executive Director", image: "/profile/dunli.jpeg" },
    { name: "Hazel Lim", role: "Co-Founder, Executive Director", image: "/profile/hazel.jpeg" },
  ],
  exco: [
    { name: "Ernest Tan", role: "Head of Tech Department", image: "/profile/ernest.jpg" },
    { name: "Yahaya B. Barison ", role: " Executive of Event Department,", image: "/profile/yahaya.jpeg" },
    { name: "Estelle Sia", role: "Executive of External Relation Department", image: "/profile/estelle.jpeg" },
    { name: "Daniel Yip", role: "Executive of External Relation Department", image: "/profile/daniel.jpeg" },
    { name: "Yan He Tan", role: "Executive of External Relation Department", image: "/profile/yanhe.jpeg" },
  ],
  advisors: [
    ...
    <div className="!min-h-screen !bg-black !text-white !font-sans !py-20 !px-4">
      ...
      <section className="!text-center !mb-20">
        ...
        <section className="!text-center !py-20 !px-4">
          <h1 className="!text-7xl !font-bold !mb-20 !mt-20">Board of Advisors</h1>
            ...
            {TEAM_MEMBERS.advisors.map((member, index) => (
              <div key={index} className="!flex !flex-col !items-center">
                ...
                <div className="!bg-zinc-800/50 !pt-14 !pb-6 !px-10 !rounded-3xl !w-72 !border !border-zinc-700 !z-0 !min-h-[160px] !flex !flex-col !justify-center">
                  ...
                  <p className="!text-zinc-500 !text-sm !italic">{member.role}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Directors Section */}
      <section className="!text-center !mb-20">
        <h1 className="!text-7xl !font-bold !mb-5 !mt-20">Board of Executive Directors</h1>
        
        <div className="!flex !flex-wrap !justify-center !gap-8 !mt-15 ">
          {TEAM_MEMBERS.directors.map((member, index) => (
            <div key={index} className="!relative !flex !flex-col !items-center !pt-10">
      ...
      <section className="!text-center">
        <h1 className="!text-6xl !font-bold !mb-5 !mt-20">Board of Committees</h1>
